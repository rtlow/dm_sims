...
#
#   make CONFIG=MyNewConf.sh EXEC=Arepo_new
# 
#-----------------------------------------------------------------
#
...
HDF5INCL    =
MPICHLIB    =     
OPTIMIZE += -std=c11 -O2 -g -Wall -parallel -ipo -funroll-loops -xcore-avx2 
ifeq (NUM_THREADS,$(findstring NUM_THREADS,$(CONFIGVARS))) 
OPTIMIZE  +=  -openmp
else
...
ifeq ($(SYSTYPE),"Gordon") # NOTYPEPREFIX_FFTW #module load fftw/2.1.5 hdf5/1.8.11 gsl/1.15
...
ifeq ($(SYSTYPE),"Kraken_pgi")
CC       =  cc -Mmpi=mpich1 
OPTIMIZE =  -std=c11 
GSL_INCL = -I/sw/xt-cle3.1/gsl/1.14/cnl3.1_pgi11.6.0/include
GSL_LIBS = -L/sw/xt-cle3.1/gsl/1.14/cnl3.1_pgi11.6.0/lib
FFTW_INCL= -I/sw/xt-cle3.1/fftw/2.1.5/cnl3.1_pgi11.9.0/include
FFTW_LIBS= -L/sw/xt-cle3.1/fftw/2.1.5/cnl3.1_pgi11.9.0/lib
HDF5INCL = -I/sw/xt-cle3.1/hdf5/1.6.10/cnl3.1_pgi11.6.0/include
HDF5LIB  = -L/sw/xt-cle3.1/hdf5/1.6.10/cnl3.1_pgi11.6.0/lib -lhdf5 -L/sw/xt-cle3.1/szip/2.1/sles11.1_pgi11.6.0/lib -lsz -lz
OPT      += -DNOCALLSOFSYSTEM
endif
...
ifeq (TGCHEM,$(findstring TGCHEM,$(CONFIGVARS)))
CVODE_INCL =  -I/u/tgreif/libs/cvode/include
CVODE_LIB  =  -L/u/tgreif/libs/cvode/lib -lsundials_cvode -lsundials_nvecserial
endif
ifeq (HEALRAY,$(findstring HEALRAY,$(CONFIGVARS)))
HEALPIX_INCL = -I/u/tgreif/libs/healpix/include
HEALPIX_LIB  = -L/u/tgreif/libs/healpix/lib -lchealpix
endif
#OPT      +=  -DOLD_HDF5
OPT      +=  -DNOCALLSOFSYSTEM
endif
...
ifeq ($(SYSTYPE),"Ubuntu")
CC       =  mpicc -O3   # sets the C-compiler
...
MPICHLIB =
HDF5INCL =  $(HDF5_INC) -DH5_USE_16_API=1
HDF5LIB  =  -L/lrz/sys/libraries/hdf5/1.8.12/serial_gpfs/lib -lhdf5
ifeq (NUM_THREADS,$(findstring NUM_THREADS,$(CONFIGVARS)))
OPTIMIZE +=  -openmp
else
OPTIMIZE += -diag-disable 3180
...
OBJS = powerspec_vel.o  \
         ...
         refinement.o criterion_refinement.o	\
         ...
         twopoint.o diffusion_general.o\
...
OBJS   += SGChem/const_rates.o  SGChem/photoinit_ism.o  SGChem/spline.o  SGChem/cheminmo.o  SGChem/coolinmo.o SGChem/sgchem.o \
          SGChem/cool_util.o  SGChem/jac.o  SGChem/cool_func.o  SGChem/rate_eq_simple.o SGChem/evolve_abundances.o \
          SGChem/init_chemistry_parameters.o SGChem/calc_shield.o SGChem/dvode.o \
          SGChem/validate_rates.o
INCL   += SGChem/cool.h SGChem/fs_data.h  SGChem/mol_data.h  SGChem/shield_data.h  SGChem/h2heat.h  SGChem/isrf.h \
          SGChem/current_photo.h  SGChem/non_eq.h  SGChem/sgchem_proto.h  SGChem/f2c.h
SUBDIRS += SGChem
endif
...
OBJS    += cosmic_rays/cosmic_rays_diffusion.o
endif
...
CFLAGS = $(OPTIMIZE) $(OPT) $(HDF5INCL) $(GSL_INCL) $(FFTW_INCL) $(CVODE_INCL) $(CFITSIO_INCL) $(HEALPIX_INCL) $(GMP_INCL) $(MKL_INCL) $(CUDA_INCL) $(HWLOC_INCL) -I$(BUILD_DIR)  $(NBC_INCL) $(HYPRE_INCL) $(VTUNE_INCL) $(GRACKLE_INCL)

CFLAGS_CUDA = $(CUDA_OPTIMIZE) $(OPT) $(GSL_INCL) $(FFTW_INCL) $(HDF5INCL) $(CVODE_INCL) $(CFITSIO_INCL) $(HEALPIX_INCL) $(GMP_INCL) $(MKL_INCL) $(CUDA_INCL)  $(VTUNE_INCL) $(GRACKLE_INCL) -I$(BUILD_DIR)

LIBS = $(MATHLIB) $(HDF5LIB) $(MPICHLIB) $(GSL_LIBS) $(GSLLIB) $(FFTW_LIB) $(GMP_LIBS) $(GMPLIB) $(CVODE_LIB) $(CFITSIO_LIB) $(HEALPIX_LIB) $(MKL_LIBS) $(THREAD_LIB) $(CUDA_LIBS) $(HWLOC_LIB) $(NBC_LIB) $(HYPRE_LIB) $(VTUNE_LIBS) $(GRACKLE_LIBS)
...
DOCS_CHECK = $(BUILD_DIR)/README-Config.check
...
$(BUILD_DIR)/README-Config.check: README-Config.md Template-Config.sh check.py
